...
def sendRequest(category,url,index):
    ...
    if 'CF-Cache-Status' in res.headers:
        print(res.headers['CF-Cache-Status'] + f" {res.status_code}  {index}")
